...
public class DashboardFragment extends Fragment {
        ...
        mExpenseDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot mysnap:snapshot.getChildren()){
                    ...
                    totalExpenseResult.setText(String.format("₱%s", strResult));

                }
                balance=totalsumincome-totalsumexpense;
                String strBalance=String.valueOf(balance);
                totalBalanceResult.setText(String.format("₱%s", strBalance));
            }
        ...
        mIncomeDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot mysnap:snapshot.getChildren()){
                    ...
                    totalIncomeResult.setText(String.format("₱%s", stResult));;
                ...
                if(balance>0.05*totalsumincome && balance<=0.1*totalsumincome){
                    ...
                    androidx.appcompat.app.AlertDialog.Builder builder=new androidx.appcompat.app.AlertDialog.Builder(getActivity());
                    builder.setTitle("You have negative balance!");
                    builder.setMessage("Need to control your expenses.");
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
    ...
    public void incomeDataInsert() {
        ...
        final TextInputEditText edtDate = myviewm.findViewById(R.id.date_edt);
        Calendar calendar = Calendar.getInstance();

        EditText edtAmount = myviewm.findViewById(R.id.amount_edt);
        EditText edtNote = myviewm.findViewById(R.id.note_edt);

        // Add dropdown menu for income category selection
        Spinner spinnerCategory = myviewm.findViewById(R.id.spinner_income_category);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mAuth.getCurrentUser() != null) {
                    ...
                    String mDate = edtDate.getText().toString(); // Retrieve the selected date from the DatePickerDialog
    ...
    public void expenseDataInsert() {
        ...
        View myviewm = inflater.inflate(R.layout.custom_layout_for_expensedata, null);
        mydialog.setView(myviewm);
        AlertDialog dialog = mydialog.create();
        ...
        // Add dropdown menu for expense category selection
        Spinner spinnerCategory = myviewm.findViewById(R.id.spinner_expense_category);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(getActivity(),
