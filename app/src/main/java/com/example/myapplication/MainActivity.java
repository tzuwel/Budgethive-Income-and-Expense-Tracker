...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView=findViewById(R.id.bhive_image);
        textView1=findViewById(R.id.bhive_text1);
        textView2=findViewById(R.id.bhive_text2);
        textView2=findViewById(R.id.bhive_text3);
